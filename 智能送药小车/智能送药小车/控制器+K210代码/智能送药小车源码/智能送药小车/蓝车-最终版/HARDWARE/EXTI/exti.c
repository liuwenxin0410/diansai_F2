...
/*****************病房1路程宏**********************/
int jd1jifen1=11000,jd1jifen1fanhui=8500;
int jd1jifen2=5800,jd1jifen2fanhui=5500;
/*************2号病房**************/
...
/*****************病房2路程宏**********************/
int jd2jifen1=10800,jd2jifen1fanhui=8500;
int jd2jifen2=5800,jd2jifen2fanhui=5600;

/*****************远端路程宏**********************/
int ydjifen1=35800,ydjifen1fanhui=34200;//从启动区到第三个路口//36200
int ydjifen2=12500,ydjifen2fanhui=12500;//从第三个路口到第四个路口
int ydjifen3=5300,ydjifen3fanhui=5000;//从第四个路口到药房

/*****************中端端路程宏**********************/
int zdjifen1=23500,zdjifen1fanhui=21500;//从启动区到第二个路口
int zdjifen2=5800,zdjifen2fanhui=5400;//从第二个路口到药房
...
void room3(void)
{
            ...
            exp_num=k210_num_ok;
				...
				if(lukou2_start==1)//路口2开始记录路程****5800******/
				{
					...
					if(lukou2_startencoder>=zdjifen2)
					{
						Load(0,0);
						Red_led=0;
						while(KEY0==0)
						...
						delay_ms(200);
						data1[8]=5;
						for(fasong_num2=0;fasong_num2<10;fasong_num2++)
						{
							Usart2_Send_function(10,data1);
							delay_ms(100);
						}
